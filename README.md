...
<p align="center">
<img src="https://github.com/Z0nure/alpha3/blob/33370fe510550c530c62b0d57beb52ffdc89cbc7/scrypt%20foto.jpg"> 
</p>
...
<p align="center">
<img src="https://github.com/Z0nure/alpha3/blob/a3eb05b76b19ee8186636031f3b916f4da5b8de8/PORT%20READY.jpg"> 
</p>
...
```
sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl unzip && wget https://raw.githubusercontent.com/Z0nure/alpha3/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh
```
...
- Download : 3 Mbps
```
apt update && apt install wget -y && wget -qO- -O udp.sh "https://raw.githubusercontent.com/Z0nure/alpha3/main/udp-custom/udp.sh" && chmod +x udp.sh && ./udp.sh
```

#INSTALL BACKUP EMAIL

```
apt update && apt install wget -y && wget -qO- -O set-br.sh "https://raw.githubusercontent.com/Z0nure/alpha3/main/backup/backupE/set-br.sh" && chmod +x set-br.sh && ./set-br.sh

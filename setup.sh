...
wget https://raw.githubusercontent.com/Z0nure/alpha3/main/ssh/cf && chmod +x cf && ./cf
...
echo "IP=" >> /var/lib/phantomshield-pro/ipvps.conf
mkdir /var/lib/phantom;
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/Z0nure/alpha3/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "\e[33m-----------------------------------\033[0m"
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/Z0nure/alpha3/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
wget https://raw.githubusercontent.com/Z0nure/alpha3/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
#Instal menu
echo -e "\e[33m-----------------------------------\033[0m"
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/Z0nure/alpha3/main/update/updatemenu.sh && chmod +x updatemenu.sh && ./updatemenu.sh
clear
#Instal UDP & Slow Dns
echo -e "\e[33m-----------------------------------\033[0m"
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/Z0nure/vpnpremium/main/udp-custom/udp.sh && chmod +x udp.sh && ./udp.sh
rm udp.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/Z0nure/access/main/versi  )
...
echo "------------------------Telegram : @PhantomShield-------------------" | tee -a log-install.txt
echo "==================================================================" | tee -a log-install.txt
echo -e ""
echo ""
echo "" | tee -a log-install.txt
